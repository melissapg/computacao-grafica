 ...
 * Summary.
 *
 * <p>This set of controls performs orbiting, dollying (zooming), and panning.<br>
 * Unlike TrackballControls, it maintains the "up" direction object.up (+Y by default).</p>
 * <ul>
 ...
 * @see <a href="/cwdc/13-webgl/OrbitControls.js">source</a>
...
/**
* <p>Orbit controls allow the camera to orbit around a target.</p>
...
class OrbitControls extends EventDispatcher {
   ...
   * @param {THREE.PerspectiveCamera | THREE.OrthographicCamera} object
   *    The camera to be controlled. The camera must not be a child of another object, unless that object is the scene itself.
   * @param {HTMLCanvasElement} domElement The HTML element used for event listeners.
